...
/// Wraps the `cohort_outcomes` Postgres RPC. The RPC enforces the 20-person
/// privacy floor server-side, so a missing drug in the result means
/// "fewer than 20 matched users" — never something the client decides.
